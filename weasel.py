...
parser.add_argument('-t', '--access_token', required=True, type=str, help='Facebook Access Token. Get one from the Graphi API Explorer')
...
def call_all_gets(access_token, version, limit):
...
call_all_gets(args.access_token, args.version, args.limit)
